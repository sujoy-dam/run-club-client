  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text font-bold text-center mb-10">What Our Runners Say</h2>
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-base-200 p-6 rounded-lg shadow-md transform transition-transform hover:scale-105">
