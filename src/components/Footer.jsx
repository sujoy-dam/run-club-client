...
const Footer = () => {
  return (
    <footer className="bg-violet-500 text-white pt-10 px-5 md:px-0">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
        {/* Logo and Description */}
        <div>
          <div className='flex items-center gap-3'>

          <h2 className="text-xl lg:text-2xl font-bold mb-4 uppercase">runclub</h2>
          <img className='w-10 lg:w-12 lg:h-12  rounded-full' src={logo} alt="" />
          </div>
          <p className="">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link to="/about" className="link link-hover hover:text-gray-950">
                About Us
              </Link>
            </li>
            <li>
              <Link to="/latest" href="#events" className="link link-hover hover:text-gray-950">
                Upcoming Events
              </Link>
            </li>
            <li>
              <Link to="/contact" className="link link-hover hover:text-gray-950">
                Contact
              </Link>
            </li>
            <li>
              <Link to="/faq" href="#faq" className="link link-hover hover:text-gray-950">
                FAQ
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <p className="">
            Email: <a href="mailto:info@marathonmanager.com" className="">info@marathonmanager.com</a>
          </p>
          <p className="">Phone: +8801736812348</p>
      ...
      <div className="mt-5 border-t border-gray-700 py-4 text-center">
